            ...
            for (Denuncia d : lista) {
                ...
                if (mMap != null) {
                    if(d.getSituacao().equals("Resolvido")) {
                        ...
                        mMap.addMarker(new MarkerOptions().position(mark).title("Clique aqui para reafirmar a resolução da denúncia").snippet("Quantidade de pessoas que confirmaram a resolução da denúncia: "
                                +  d.getConfiavel() ).draggable(false).icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
            ...
            public void onInfoWindowClick(Marker arg0) {
                for(Denuncia d : lista2) {
                    ...
                    if(id.equals(Integer.toString(d.getCodigo()))) {
                        ...
                        args.putInt("conf", d.getConfiavel());
